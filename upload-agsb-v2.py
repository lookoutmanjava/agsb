...
# ====== 全局可配置参数（可直接在此处修改） ======
USER_NAME = "lee1595"         # 用户名
UUID = "a91b59b6-ade4-497d-b4e9-88d184c48048"                     # UUID，留空则自动生成
PORT = 49999                   # Vmess端口，留空或0则自动生成
DOMAIN = "lee.leee1595.dpdns.org"                   # 域名，留空则自动获取
CF_TOKEN = "eyJhIjoiMDUzMWFlYWM5ZjlkMjdmODM5MDI3MGZmMWMzMjY2M2UiLCJ0IjoiNjM1MzhlMGQtMTdlMC00ZTYyLThlZTctNjVlMWEwNGU5ZGMzIiwicyI6IlpqWTVaak00TW1NdE16azJZUzAwT0RVeExUaGlOMlF0TldZeU9EY3pNV1ptTkdJMSJ9"                 # Cloudflare Token，留空则用Quick Tunnel
# =========================================
